"""Adapter for Central European Times (https://centraleuropeantimes.com)."""
...
class CentralEuropeanTimesAdapter(BaseSiteAdapter):
    """Adapter for Central European Times."""

    SITE_ID = "centraleuropeantimes"
    SITE_NAME = "Central European Times"
    SITE_URL = "https://centraleuropeantimes.com"
    LANGUAGE = "en"
    GROUP = "G"
    REGION = "EU"
    ...
    RSS_URL = "https://centraleuropeantimes.com/feed"
    SITEMAP_URL = "https://centraleuropeantimes.com/sitemap.xml"
