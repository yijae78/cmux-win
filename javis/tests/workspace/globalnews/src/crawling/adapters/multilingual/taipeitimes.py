"""Adapter for Taipei Times (https://www.taipeitimes.com)."""
...
class TaipeiTimesAdapter(BaseSiteAdapter):
    """Adapter for Taipei Times."""

    SITE_ID = "taipeitimes"
    SITE_NAME = "Taipei Times"
    SITE_URL = "https://www.taipeitimes.com"
    LANGUAGE = "en"
    GROUP = "F"
    REGION = "TW"
    ...
    RSS_URL = "https://www.taipeitimes.com/feed"
    SITEMAP_URL = "https://www.taipeitimes.com/sitemap.xml"
