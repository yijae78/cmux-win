"""Adapter for TV2 Norway (https://www.tv2.no)."""
...
class TV2NorwayAdapter(BaseSiteAdapter):
    """Adapter for TV2 Norway."""

    SITE_ID = "tv2_no"
    SITE_NAME = "TV2 Norway"
    SITE_URL = "https://www.tv2.no"
    LANGUAGE = "no"
    GROUP = "G"
    REGION = "NO"
    ...
    RSS_URL = "https://www.tv2.no/feed"
    SITEMAP_URL = "https://www.tv2.no/sitemap.xml"
