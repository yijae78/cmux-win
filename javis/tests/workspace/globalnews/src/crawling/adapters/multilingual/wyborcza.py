"""Adapter for Gazeta Wyborcza (https://wyborcza.pl)."""
...
class WyborczaAdapter(BaseSiteAdapter):
    """Adapter for Gazeta Wyborcza."""

    SITE_ID = "wyborcza"
    SITE_NAME = "Gazeta Wyborcza"
    SITE_URL = "https://wyborcza.pl"
    LANGUAGE = "pl"
    GROUP = "G"
    REGION = "PL"
    ...
    RSS_URL = "https://wyborcza.pl/feed"
    SITEMAP_URL = "https://wyborcza.pl/sitemap.xml"
