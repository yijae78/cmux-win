"""Adapter for Sueddeutsche Zeitung (https://www.sueddeutsche.de)."""
...
class SueddeutscheAdapter(BaseSiteAdapter):
    """Adapter for Sueddeutsche Zeitung."""

    SITE_ID = "sueddeutsche"
    SITE_NAME = "Sueddeutsche Zeitung"
    ...
    RSS_URL = "https://www.sueddeutsche.de/feed"
    SITEMAP_URL = "https://www.sueddeutsche.de/sitemap.xml"
