"""Adapter for Antara News (https://en.antaranews.com)."""
...
class AntaraNewsAdapter(BaseSiteAdapter):
    """Adapter for Antara News."""

    SITE_ID = "antaranews"
    SITE_NAME = "Antara News"
    SITE_URL = "https://en.antaranews.com"
    LANGUAGE = "en"
    GROUP = "F"
    REGION = "ID"
    ...
    RSS_URL = "https://en.antaranews.com/feed"
    SITEMAP_URL = "https://en.antaranews.com/sitemap.xml"
