"""Adapter for AllAfrica (https://allafrica.com)."""
...
class AllAfricaAdapter(BaseSiteAdapter):
    """Adapter for AllAfrica."""
    ...
    RSS_URL = "https://allafrica.com/feed"
    SITEMAP_URL = "https://allafrica.com/sitemap.xml"
