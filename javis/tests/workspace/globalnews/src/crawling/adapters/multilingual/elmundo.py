"""Adapter for El Mundo (https://www.elmundo.es)."""
...
class ElMundoAdapter(BaseSiteAdapter):
    """Adapter for El Mundo."""
    ...
    RSS_URL = "https://www.elmundo.es/feed"
    SITEMAP_URL = "https://www.elmundo.es/sitemap.xml"
