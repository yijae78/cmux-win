"""Adapter for Times of India (https://timesofindia.indiatimes.com)."""
...
class TimesOfIndiaAdapter(BaseSiteAdapter):
    """Adapter for Times of India."""

    SITE_ID = "timesofindia"
    ...
    RSS_URL = "https://timesofindia.indiatimes.com/feed"
    SITEMAP_URL = "https://timesofindia.indiatimes.com/sitemap.xml"
