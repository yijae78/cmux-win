"""Adapter for Yahoo Japan News (https://news.yahoo.co.jp)."""
...
class YahooJPAdapter(BaseSiteAdapter):
    """Adapter for Yahoo Japan News."""

    SITE_ID = "yahoo_jp"
    SITE_NAME = "Yahoo Japan News"
    ...
    RSS_URL = "https://news.yahoo.co.jp/feed"
    SITEMAP_URL = "https://news.yahoo.co.jp/sitemap.xml"
