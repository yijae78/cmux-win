"""Adapter for Haaretz (https://www.haaretz.com)."""
...
class HaaretzAdapter(BaseSiteAdapter):
    """Adapter for Haaretz."""

    SITE_ID = "haaretz"
    SITE_NAME = "Haaretz"
    SITE_URL = "https://www.haaretz.com"
    LANGUAGE = "en"
    GROUP = "G"
    REGION = "IL"
    ...
    RSS_URL = "https://www.haaretz.com/feed"
    SITEMAP_URL = "https://www.haaretz.com/sitemap.xml"
