"""Adapter for Middle East Eye (https://www.middleeasteye.net)."""
...
class MiddleEastEyeAdapter(BaseSiteAdapter):
    """Adapter for Middle East Eye."""

    SITE_ID = "middleeasteye"
    ...
    RSS_URL = "https://www.middleeasteye.net/feed"
    SITEMAP_URL = "https://www.middleeasteye.net/sitemap.xml"
