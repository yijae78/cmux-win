"""Adapter for Der Spiegel (https://www.spiegel.de)."""
...
class SpiegelAdapter(BaseSiteAdapter):
    """Adapter for Der Spiegel."""
    ...
    RSS_URL = "https://www.spiegel.de/feed"
    SITEMAP_URL = "https://www.spiegel.de/sitemap.xml"
