"""Adapter for Iceland Monitor (https://icelandmonitor.mbl.is/news/)."""
...
class IcelandMonitorAdapter(BaseSiteAdapter):
    """Adapter for Iceland Monitor."""

    SITE_ID = "icelandmonitor"
    SITE_NAME = "Iceland Monitor"
    SITE_URL = "https://icelandmonitor.mbl.is/news/"
    LANGUAGE = "en"
    GROUP = "G"
    REGION = "IS"
    ...
    RSS_URL = "https://icelandmonitor.mbl.is/news/feed"
    SITEMAP_URL = "https://icelandmonitor.mbl.is/news/sitemap.xml"
