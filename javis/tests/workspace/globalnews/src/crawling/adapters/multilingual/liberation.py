"""Adapter for Liberation (https://www.liberation.fr)."""
...
class LiberationAdapter(BaseSiteAdapter):
    """Adapter for Liberation."""

    SITE_ID = "liberation"
    SITE_NAME = "Liberation"
    ...
    RSS_URL = "https://www.liberation.fr/feed"
    SITEMAP_URL = "https://www.liberation.fr/sitemap.xml"
