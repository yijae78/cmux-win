"""Adapter for Tempo Indonesia (https://en.tempo.co)."""
...
class TempoIDAdapter(BaseSiteAdapter):
    """Adapter for Tempo Indonesia."""

    SITE_ID = "tempo_id"
    SITE_NAME = "Tempo Indonesia"
    SITE_URL = "https://en.tempo.co"
    LANGUAGE = "en"
    GROUP = "F"
    REGION = "ID"
    ...
    RSS_URL = "https://en.tempo.co/feed"
    SITEMAP_URL = "https://en.tempo.co/sitemap.xml"
