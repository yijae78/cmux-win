"""Adapter for O Globo (https://oglobo.globo.com)."""
...
class OGloboAdapter(BaseSiteAdapter):
    """Adapter for O Globo."""
    ...
    RSS_URL = "https://oglobo.globo.com/feed"
    SITEMAP_URL = "https://oglobo.globo.com/sitemap.xml"
