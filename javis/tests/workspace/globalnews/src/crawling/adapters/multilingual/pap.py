"""Adapter for Polish Press Agency (https://www.pap.pl)."""
...
class PAPAdapter(BaseSiteAdapter):
    """Adapter for Polish Press Agency."""

    SITE_ID = "pap"
    SITE_NAME = "Polish Press Agency"
    SITE_URL = "https://www.pap.pl"
    LANGUAGE = "pl"
    GROUP = "G"
    REGION = "PL"
    ...
    RSS_URL = "https://www.pap.pl/feed"
    SITEMAP_URL = "https://www.pap.pl/sitemap.xml"
