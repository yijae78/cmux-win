"""Adapter for Aftonbladet (https://www.aftonbladet.se)."""
...
class AftonbladetAdapter(BaseSiteAdapter):
    """Adapter for Aftonbladet."""

    SITE_ID = "aftonbladet"
    SITE_NAME = "Aftonbladet"
    SITE_URL = "https://www.aftonbladet.se"
    LANGUAGE = "sv"
    GROUP = "G"
    REGION = "SE"
    ...
    RSS_URL = "https://www.aftonbladet.se/feed"
    SITEMAP_URL = "https://www.aftonbladet.se/sitemap.xml"
