"""Adapter for Die Welt (https://www.welt.de)."""
...
class WeltAdapter(BaseSiteAdapter):
    """Adapter for Die Welt."""

    SITE_ID = "welt"
    SITE_NAME = "Die Welt"
    SITE_URL = "https://www.welt.de"
    LANGUAGE = "de"
    GROUP = "G"
    REGION = "DE"
    ...
    RSS_URL = "https://www.welt.de/feed"
    SITEMAP_URL = "https://www.welt.de/sitemap.xml"
