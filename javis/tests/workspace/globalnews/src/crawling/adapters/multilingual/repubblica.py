"""Adapter for La Repubblica (https://www.repubblica.it)."""
...
class RepubblicaAdapter(BaseSiteAdapter):
    """Adapter for La Repubblica."""

    SITE_ID = "repubblica"
    SITE_NAME = "La Repubblica"
    SITE_URL = "https://www.repubblica.it"
    LANGUAGE = "it"
    GROUP = "G"
    REGION = "IT"
    ...
    RSS_URL = "https://www.repubblica.it/feed"
    SITEMAP_URL = "https://www.repubblica.it/sitemap.xml"
