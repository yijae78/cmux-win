"""Adapter for Mainichi Shimbun (https://mainichi.jp/english/)."""
...
class MainichiAdapter(BaseSiteAdapter):
    """Adapter for Mainichi Shimbun."""

    SITE_ID = "mainichi"
    SITE_NAME = "Mainichi Shimbun"
    SITE_URL = "https://mainichi.jp/english/"
    LANGUAGE = "en"
    GROUP = "F"
    REGION = "JP"
    ...
    RSS_URL = "https://mainichi.jp/english/feed"
    SITEMAP_URL = "https://mainichi.jp/english/sitemap.xml"
