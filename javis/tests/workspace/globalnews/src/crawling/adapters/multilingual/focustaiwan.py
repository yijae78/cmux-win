"""Adapter for Focus Taiwan (https://focustaiwan.tw)."""
...
class FocusTaiwanAdapter(BaseSiteAdapter):
    """Adapter for Focus Taiwan."""

    SITE_ID = "focustaiwan"
    SITE_NAME = "Focus Taiwan"
    SITE_URL = "https://focustaiwan.tw"
    LANGUAGE = "en"
    GROUP = "F"
    REGION = "TW"
    ...
    RSS_URL = "https://focustaiwan.tw/feed"
    SITEMAP_URL = "https://focustaiwan.tw/sitemap.xml"
