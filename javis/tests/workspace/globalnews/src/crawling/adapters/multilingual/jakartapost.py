"""Adapter for The Jakarta Post (https://www.thejakartapost.com)."""
...
class JakartaPostAdapter(BaseSiteAdapter):
    """Adapter for The Jakarta Post."""
    ...
    RSS_URL = "https://www.thejakartapost.com/feed"
    SITEMAP_URL = "https://www.thejakartapost.com/sitemap.xml"
