"""Adapter for Le Figaro (https://www.lefigaro.fr)."""
...
class LeFigaroAdapter(BaseSiteAdapter):
    """Adapter for Le Figaro."""
    ...
    RSS_URL = "https://www.lefigaro.fr/feed"
    SITEMAP_URL = "https://www.lefigaro.fr/sitemap.xml"
