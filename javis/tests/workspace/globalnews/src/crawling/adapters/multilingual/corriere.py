"""Adapter for Corriere della Sera (https://www.corriere.it)."""
...
class CorriereAdapter(BaseSiteAdapter):
    """Adapter for Corriere della Sera."""

    SITE_ID = "corriere"
    SITE_NAME = "Corriere della Sera"
    SITE_URL = "https://www.corriere.it"
    LANGUAGE = "it"
    GROUP = "G"
    REGION = "IT"
    ...
    RSS_URL = "https://www.corriere.it/feed"
    SITEMAP_URL = "https://www.corriere.it/sitemap.xml"
