"""Adapter for ABC Spain (https://www.abc.es)."""
...
class ABCSpainAdapter(BaseSiteAdapter):
    """Adapter for ABC Spain."""
    ...
    RSS_URL = "https://www.abc.es/feed"
    SITEMAP_URL = "https://www.abc.es/sitemap.xml"
