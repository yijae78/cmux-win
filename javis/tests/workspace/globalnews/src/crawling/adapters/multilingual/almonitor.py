"""Adapter for Al-Monitor (https://www.al-monitor.com)."""
...
class AlMonitorAdapter(BaseSiteAdapter):
    """Adapter for Al-Monitor."""
    ...
    RSS_URL = "https://www.al-monitor.com/feed"
    SITEMAP_URL = "https://www.al-monitor.com/sitemap.xml"
