"""Adapter for Rossiyskaya Gazeta (https://rg.ru)."""
...
class RGAdapter(BaseSiteAdapter):
    """Adapter for Rossiyskaya Gazeta."""

    SITE_ID = "rg"
    SITE_NAME = "Rossiyskaya Gazeta"
    ...
    RSS_URL = "https://rg.ru/feed"
    SITEMAP_URL = "https://rg.ru/sitemap.xml"
