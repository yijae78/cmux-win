"""Adapter for Asahi Shimbun (https://www.asahi.com)."""
...
class AsahiAdapter(BaseSiteAdapter):
    """Adapter for Asahi Shimbun."""

    SITE_ID = "asahi"
    SITE_NAME = "Asahi Shimbun"
    ...
    RSS_URL = "https://www.asahi.com/feed"
    SITEMAP_URL = "https://www.asahi.com/sitemap.xml"
