"""Adapter for Indian Express (https://indianexpress.com)."""
...
class IndianExpressAdapter(BaseSiteAdapter):
    """Adapter for Indian Express."""

    SITE_ID = "indianexpress"
    SITE_NAME = "Indian Express"
    SITE_URL = "https://indianexpress.com"
    LANGUAGE = "en"
    GROUP = "F"
    REGION = "IN"
