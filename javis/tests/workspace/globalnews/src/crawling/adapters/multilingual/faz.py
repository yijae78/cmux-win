"""Adapter for Frankfurter Allgemeine (https://www.faz.net)."""
...
class FAZAdapter(BaseSiteAdapter):
    """Adapter for Frankfurter Allgemeine."""

    SITE_ID = "faz"
    SITE_NAME = "Frankfurter Allgemeine"
    ...
    RSS_URL = "https://www.faz.net/feed"
    SITEMAP_URL = "https://www.faz.net/sitemap.xml"
