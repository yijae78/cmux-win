"""Adapter for iDNES (https://www.idnes.cz)."""
...
class IDNESAdapter(BaseSiteAdapter):
    """Adapter for iDNES."""

    SITE_ID = "idnes"
    SITE_NAME = "iDNES"
    SITE_URL = "https://www.idnes.cz"
    LANGUAGE = "cs"
    GROUP = "G"
    REGION = "CZ"
    ...
    RSS_URL = "https://www.idnes.cz/feed"
    SITEMAP_URL = "https://www.idnes.cz/sitemap.xml"
