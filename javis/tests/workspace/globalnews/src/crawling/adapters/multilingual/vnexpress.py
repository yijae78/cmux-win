"""Adapter for VnExpress International (https://e.vnexpress.net)."""
...
class VnExpressAdapter(BaseSiteAdapter):
    """Adapter for VnExpress International."""

    SITE_ID = "vnexpress"
    SITE_NAME = "VnExpress International"
    SITE_URL = "https://e.vnexpress.net"
    LANGUAGE = "en"
    GROUP = "F"
    REGION = "VN"
    ...
    RSS_URL = "https://e.vnexpress.net/feed"
    SITEMAP_URL = "https://e.vnexpress.net/sitemap.xml"
