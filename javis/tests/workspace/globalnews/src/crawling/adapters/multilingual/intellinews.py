"""Adapter for Intellinews (https://www.intellinews.com/news/)."""
...
class IntellinewsAdapter(BaseSiteAdapter):
    """Adapter for Intellinews."""

    SITE_ID = "intellinews"
    SITE_NAME = "Intellinews"
    SITE_URL = "https://www.intellinews.com/news/"
    LANGUAGE = "en"
    GROUP = "G"
    REGION = "EU"
    ...
    RSS_URL = "https://www.intellinews.com/news/feed"
    SITEMAP_URL = "https://www.intellinews.com/news/sitemap.xml"
    ...
    SECTION_URLS = [
        "https://www.intellinews.com/news/",
    ]
