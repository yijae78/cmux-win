"""Adapter for Jerusalem Post (https://www.jpost.com)."""
...
class JPostAdapter(BaseSiteAdapter):
    """Adapter for Jerusalem Post."""

    SITE_ID = "jpost"
    SITE_NAME = "Jerusalem Post"
    SITE_URL = "https://www.jpost.com"
    LANGUAGE = "en"
    GROUP = "G"
    REGION = "IL"
    ...
    RSS_URL = "https://www.jpost.com/feed"
    SITEMAP_URL = "https://www.jpost.com/sitemap.xml"
