"""Adapter for ANSA (https://www.ansa.it)."""
...
class ANSAAdapter(BaseSiteAdapter):
    """Adapter for ANSA."""

    SITE_ID = "ansa"
    SITE_NAME = "ANSA"
    SITE_URL = "https://www.ansa.it"
    LANGUAGE = "it"
    GROUP = "G"
    REGION = "IT"
    ...
    RSS_URL = "https://www.ansa.it/feed"
    SITEMAP_URL = "https://www.ansa.it/sitemap.xml"
