"""Adapter for El Tiempo (https://www.eltiempo.com)."""
...
class ElTiempoAdapter(BaseSiteAdapter):
    """Adapter for El Tiempo."""
    ...
    RSS_URL = "https://www.eltiempo.com/feed"
    SITEMAP_URL = "https://www.eltiempo.com/sitemap.xml"
