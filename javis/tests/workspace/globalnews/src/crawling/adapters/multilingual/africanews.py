"""Adapter for Africanews (https://www.africanews.com)."""
...
class AfricanewsAdapter(BaseSiteAdapter):
    """Adapter for Africanews."""

    SITE_ID = "africanews"
    SITE_NAME = "Africanews"
    ...
    SITEMAP_URL = "https://www.africanews.com/sitemap.xml"
