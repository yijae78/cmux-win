"""Adapter for The Africa Report (https://www.theafricareport.com)."""
...
class TheAfricaReportAdapter(BaseSiteAdapter):
    """Adapter for The Africa Report."""

    SITE_ID = "theafricareport"
    SITE_NAME = "The Africa Report"
    SITE_URL = "https://www.theafricareport.com"
    LANGUAGE = "en"
    GROUP = "H"
    REGION = "AF"
    ...
    SITEMAP_URL = "https://www.theafricareport.com/sitemap.xml"
