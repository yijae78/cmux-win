"""Adapter for YLE News (https://yle.fi/news)."""
...
class YLEAdapter(BaseSiteAdapter):
    """Adapter for YLE News."""

    SITE_ID = "yle"
    SITE_NAME = "YLE News"
    SITE_URL = "https://yle.fi/news"
    LANGUAGE = "en"
    GROUP = "G"
    REGION = "FI"
    ...
    RSS_URL = "https://yle.fi/news/feed"
    SITEMAP_URL = "https://yle.fi/news/sitemap.xml"
