"""Adapter for Hindustan Times (https://www.hindustantimes.com)."""
...
class HindustanTimesAdapter(BaseSiteAdapter):
    """Adapter for Hindustan Times."""

    SITE_ID = "hindustantimes"
    SITE_NAME = "Hindustan Times"
    SITE_URL = "https://www.hindustantimes.com"
    LANGUAGE = "en"
    GROUP = "F"
    REGION = "IN"
    ...
    RSS_URL = "https://www.hindustantimes.com/feed"
    SITEMAP_URL = "https://www.hindustantimes.com/sitemap.xml"
