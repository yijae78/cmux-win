"""Adapter for Techmeme (https://www.techmeme.com)."""
...
class TechmemeAdapter(BaseSiteAdapter):
    """Adapter for Techmeme."""
    ...
    RSS_URL = "https://www.techmeme.com/feed"
    SITEMAP_URL = "https://www.techmeme.com/sitemap.xml"
