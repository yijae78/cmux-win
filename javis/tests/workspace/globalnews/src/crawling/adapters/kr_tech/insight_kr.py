"""Adapter for Insight Korea (https://insight.co.kr)."""
...
class InsightKrAdapter(BaseSiteAdapter):
    """Adapter for Insight Korea."""

    SITE_ID = "insight_kr"
    SITE_NAME = "Insight Korea"
    SITE_URL = "https://insight.co.kr"
    LANGUAGE = "ko"
    GROUP = "D"
    REGION = "KR"
    ...
    RSS_URL = "https://insight.co.kr/feed"
    SITEMAP_URL = "https://insight.co.kr/sitemap.xml"
