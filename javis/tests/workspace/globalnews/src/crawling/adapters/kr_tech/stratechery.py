"""Adapter for Stratechery (https://stratechery.com)."""
...
class StratecheryAdapter(BaseSiteAdapter):
    """Adapter for Stratechery."""

    SITE_ID = "stratechery"
    SITE_NAME = "Stratechery"
    ...
    SITEMAP_URL = "https://stratechery.com/sitemap.xml"
