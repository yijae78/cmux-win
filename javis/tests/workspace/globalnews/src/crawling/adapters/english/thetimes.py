"""Adapter for The Times (https://www.thetimes.com)."""
...
class TheTimesAdapter(BaseSiteAdapter):
    """Adapter for The Times."""

    SITE_ID = "thetimes"
    SITE_NAME = "The Times"
    SITE_URL = "https://www.thetimes.com"
    LANGUAGE = "en"
    GROUP = "E"
    REGION = "GB"
    ...
    SITEMAP_URL = "https://www.thetimes.com/sitemap.xml"
