"""Adapter for Nature Asia (https://www.natureasia.com)."""
...
class NatureAsiaAdapter(BaseSiteAdapter):
    """Adapter for Nature Asia."""

    SITE_ID = "natureasia"
    SITE_NAME = "Nature Asia"
    SITE_URL = "https://www.natureasia.com"
    LANGUAGE = "en"
    GROUP = "E"
    REGION = "JP"
    ...
    RSS_URL = "https://www.natureasia.com/feed"
    SITEMAP_URL = "https://www.natureasia.com/sitemap.xml"
