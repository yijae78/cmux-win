"""Adapter for Politico Europe (https://www.politico.eu)."""
...
class PoliticoEUAdapter(BaseSiteAdapter):
    """Adapter for Politico Europe."""

    SITE_ID = "politico_eu"
    SITE_NAME = "Politico Europe"
    ...
    SITEMAP_URL = "https://www.politico.eu/sitemap.xml"
