"""Adapter for The Guardian (https://www.theguardian.com)."""
...
class TheGuardianAdapter(BaseSiteAdapter):
    """Adapter for The Guardian."""
    ...
    RSS_URL = "https://www.theguardian.com/feed"
    SITEMAP_URL = "https://www.theguardian.com/sitemap.xml"
