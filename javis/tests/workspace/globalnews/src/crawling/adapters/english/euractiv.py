"""Adapter for Euractiv (https://www.euractiv.com)."""
...
class EuractivAdapter(BaseSiteAdapter):
    """Adapter for Euractiv."""

    SITE_ID = "euractiv"
    SITE_NAME = "Euractiv"
    SITE_URL = "https://www.euractiv.com"
    LANGUAGE = "en"
    GROUP = "E"
    REGION = "EU"
    ...
    SITEMAP_URL = "https://www.euractiv.com/sitemap.xml"
