...
export const DEFAULT_SHORTCUTS: ShortcutDef[] = [
  ...
  {
    id: 'togglePanels',
    label: 'Toggle Panels (Collapse/Expand)',
    defaultKey: 'Ctrl+`',
    category: 'view',
  },
  {
    id: 'equalizeHorizontal',
    label: 'Equal Width (Horizontal)',
    defaultKey: 'Ctrl+Shift+=',
    category: 'view',
  },
  {
    id: 'equalizeVertical',
    label: 'Equal Height (Vertical)',
    defaultKey: 'Ctrl+Alt+=',
    category: 'view',
  },
  { id: 'reloadApp', label: 'Reload App', defaultKey: 'Ctrl+Shift+F5', category: 'view' },
];
