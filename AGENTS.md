...
이 프로젝트는 **cmux-win**입니다. Windows용 AI 에이전트 터미널 멀티플렉서로, 여러 AI CLI(Codex, Gemini, Codex 등)를 동시에 실행하고 협업시킬 수 있는 Electron 기반 데스크톱 앱입니다.
...
│ (200px)  │  (분할 가능, 드래그 재배치)          │
│──────────│                                      │
│ Explorer │  [Codex CLI] [Gemini CLI] [Codex]  │
│ (파일)   │                                      │
│──────────│                                      │
│ 🧠Codex │                                      │
│ 💎Gemini │                                      │
...
### 6. 브라우저 패널
- 사이드바에서 🧠Codex.ai / 💎Gemini / 🤖ChatGPT 클릭 → 브라우저 패널 열기
